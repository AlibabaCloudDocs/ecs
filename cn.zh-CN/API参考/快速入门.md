...
-   [阿里云CLI示例](#section_rmm_adh_0cj)：适用于常使用命令行工具的场景。请确保您已经为ECS实例安装了阿里云CLI，在不同操作系统中安装CLI的方式请参见：
    ...
    -   [在Linux上安装阿里云CLI]()
    -   [在macOS上安装阿里云CLI]()
-   [OpenAPI Explorer示例](#section_31b_k7x_jgg)：适用于习惯交互式操作界面的场景，或者初次使用阿里云产品的开发者用户。您可以在OpenAPI Explorer中调试和获取SDK请求示例。更多有关OpenAPI Explorer的详情，请参见[OpenAPI开发者门户](https://next.api.aliyun.com/api/Ecs/2014-05-26)。
