...
1.  接入云监控SDK，具体操作请参见[Java SDK使用手册](/cn.zh-CN/SDK参考/Java SDK使用手册.md)。
...
使用[DescribeInstances](/cn.zh-CN/API参考/实例/DescribeInstances.md)，根据返回的OperationLocks判断实例是否进入待回收状态。
