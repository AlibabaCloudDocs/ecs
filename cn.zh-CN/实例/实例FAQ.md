...
您可以通过[云监控控制台](https://cloudmonitor.console.aliyun.com/)或[DescribeMetricList](/cn.zh-CN/API参考/云产品监控/DescribeMetricList.md)来查看GPU监控数据，详情请参见[t15305.md\#](/cn.zh-CN/主机监控/GPU监控.md)。
...
如果您需要确认待回收状态，请通过[实例元数据](/cn.zh-CN/实例/管理实例/使用实例元数据/ECS实例元数据概述.md)或者[DescribeInstances](/cn.zh-CN/API参考/实例/DescribeInstances.md)接口返回的OperationLocks信息查看实例状态。
...
通用的网络收发包测试方法，请参见[使用Netperf测试网络性能](https://help.aliyun.com/document_detail/55757.html)。g7、c7、r7实例的推荐网络收发包测试方法，请参见[使用Pktgen测试网络性能](https://help.aliyun.com/document_detail/260258.html)。
