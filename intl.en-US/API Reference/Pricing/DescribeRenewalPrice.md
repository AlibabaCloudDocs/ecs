...
|ResourceId|String|Yes|i-bp1f2o4ldh8l29zv\*\*\*\*|The ID of the specified resource whose renewal price is to be queried. When the `ResourceType` parameter is set to `instance`, the value of `ResourceId` is that of `InstanceId`. |
...
|DetailInfos|Array of ResourcePriceModel| |Details about the resource prices. |
|ResourcePriceModel| | | |
