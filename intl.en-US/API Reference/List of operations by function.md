...
The following tables list the API operations available for use in ECS.
...
|[AttachInstanceRamRole](/intl.en-US/API Reference/Instances/AttachInstanceRamRole.md)|Attaches an instance RAM role to one or more instances. An instance can have only one instance RAM role. If an instance already has an instance RAM role, an error is returned when you attach another instance RAM role to the instance.|
...
|[DescribeInstances](/intl.en-US/API Reference/Instances/DescribeInstances.md)|Queries the details of one or more instances.|
...
|[t1881581.md\#](/intl.en-US/API Reference/Instances/ModifyInstanceMetadataOptions.md)|Modifies the metadata of an instance.|
...
|[t1941191.md\#](/intl.en-US/API Reference/Dedicated hosts/CreateDedicatedHostCluster.md)|Creates a dedicated host cluster.|
|[t1948326.md\#](/intl.en-US/API Reference/Dedicated hosts/DescribeDedicatedHostClusters.md)|Queries the details of one or more dedicated host clusters.|
|[t1948340.md\#](/intl.en-US/API Reference/Dedicated hosts/ModifyDedicatedHostClusterAttribute.md)|Modifies some properties of a dedicated host cluster, such as its name and description.|
|[t1948344.md\#](/intl.en-US/API Reference/Dedicated hosts/DeleteDedicatedHostCluster.md)|Deletes a dedicated host cluster.|
...
|[t1883854.md\#](/intl.en-US/API Reference/Dedicated hosts/RedeployDedicatedHost.md)|Migrates instances from a failed dedicated host.|
|[DescribeDedicatedHosts](/intl.en-US/API Reference/Dedicated hosts/DescribeDedicatedHosts.md)|Queries the details of one or more dedicated hosts, including the physical performance specifications, machine codes, service status, and a list of ECS instances that are created on the dedicated hosts.|
|[DescribeDedicatedHostTypes](/intl.en-US/API Reference/Dedicated hosts/DescribeDedicatedHostTypes.md)|Queries the details of dedicated host types supported in a region, or the ECS instance families supported by a specific dedicated host type.|
...
|[t1887932.md\#](/intl.en-US/API Reference/Dedicated hosts/ModifyDedicatedHostsChargeType.md)|Changes the billing method of one or more dedicated hosts.|
...
|API|Description|
|---|-----------|
|[t1881884.md\#](/intl.en-US/API Reference/Storage Capacity Units/PurchaseStorageCapacityUnit.md)|Purchases one or more SCUs.|
|[t1881881.md\#](/intl.en-US/API Reference/Storage Capacity Units/ModifyStorageCapacityUnitAttribute.md)|Modifies the name and description of an SCU.|
|[t1881883.md\#](/intl.en-US/API Reference/Storage Capacity Units/DescribeStorageCapacityUnits.md)|Queries the details of one or more SCUs.|
...
|[ExportImage](/intl.en-US/API Reference/Images/ExportImage.md)|Exports a custom image to an OSS bucket in the same region.|
...
|[t1883974.md\#](/intl.en-US/API Reference/Snapshots/CopySnapshot.md)|Copies a normal snapshot from one region to another.|
...
|[t1912281.md\#](/intl.en-US/API Reference/Deployment sets/DescribeDeploymentSetSupportedInstanceTypeFamily.md)|Queries the instance families that support deployment sets.|
...
|[AttachClassicLinkVpc](/intl.en-US/API Reference/Networks/AttachClassicLinkVpc.md)|Links a classic network-type instance to a VPC by establishing a ClassicLink connection between them. This way, the instance can communicate with cloud resources in the VPC over the internal network.|
...
|[t125737.md\#](/intl.en-US/API Reference/System event/AcceptInquiredSystemEvent.md)|Accepts the default operation for a system event in the Inquiring state and authorizes the system to perform the default operation.|
...
|[t1856559.md\#](/intl.en-US/API Reference/Operations and monitoring/DescribeInstanceMaintenanceAttributes.md)|Queries the maintenance properties of an instance.|
|[t1856571.md\#](/intl.en-US/API Reference/Operations and monitoring/ModifyInstanceMaintenanceAttributes.md)|Modifies the maintenance properties of an instance.|
