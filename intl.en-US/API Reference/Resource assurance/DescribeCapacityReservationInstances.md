...
You can call this operation to query the instances that match a capacity reservation.
...
|---------|----|-------|-----------|
|CapacityReservationItem|Array of InstanceIdSet| |The instances that match the capacity reservation. |
|InstanceIdSet| | | |
