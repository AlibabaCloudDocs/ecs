...
|DiskId|String|Yes|d-bp131n0q38u3a4zi\*\*\*\*|The ID of the disk. |
|DiskCategory|String|No|cloud\_essd|The new category of the disk. Valid values:
...
|PerformanceLevel|String|No|PL2|The new performance level of the ESSD. Valid values:
...
|403|OperationDenied.PerformanceLevelNotMatch|The specified PerformanceLevel and disk size do not match.|The error message returned because the performance level of the ESSD cannot be upgraded due to its capacity.|
