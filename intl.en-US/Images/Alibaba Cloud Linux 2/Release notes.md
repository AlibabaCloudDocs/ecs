...
-   Kernel updates:
    ...
    -   Transparent Huge Pages \(THP\) Fork is optimized to accelerate the creation of memory intensive processes.
...
-   Kernel updates:
    ...
    -   The kernel interface support provided by the Alibaba Cloud kernel on priority control when a memcg is out of memory \(OOM\) is open sourced to improve the protection on important processes during system OOM.
...
-   Kernel updates:
    ...
    -   Intel Cooper Lake and Ice Lake processors are supported.
