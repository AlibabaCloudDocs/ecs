...
-   Applicable regions: China \(Hangzhou\), China \(Shenzhen\), China \(Beijing\), China \(Zhangjiakou\), China \(Hong Kong\), Singapore, Malaysia \(Kuala Lumpur\), and US \(Virginia\). |
...
-   The time synchronization latency that was presented on instance startup is fixed.
