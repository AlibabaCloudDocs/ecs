...
**Note:** Burstable instances are also shared instances. For more information, see [Overview](/intl.en-US/Instance/Instance type families/Burstable performance instances/Overview.md).
