...
7.  In the System Configurations step, specify **RAM Role**.
    ...
    **Note:** You can also skip the authorization step and grant permissions after the instance is created. For more information, see the [Bind an instance RAM role](/intl.en-US/Security/Instance RAM roles/Bind an instance RAM role.md) section.
...
|---------|-----------|-------|
|InstanceType|The instance type of the security-enhanced instance. ECS provides the following security-enhanced instance families:-   g6t
-   c6t
