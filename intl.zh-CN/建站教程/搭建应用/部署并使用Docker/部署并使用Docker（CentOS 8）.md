---
keyword: [Docker, 容器, Linux, ECS, 云服务器, 阿里云, CentOS 8]
---
...
-   已创建了至少一台ECS实例。具体操作步骤请参见[使用向导创建实例](/intl.zh-CN/实例/创建实例/使用向导创建实例.md)。
...
-   部署Docker，详情请参见[部署Docker](#section_kjt_i59_n4a)。
-   使用Docker。
    -   Docker的基本用法介绍，请参见[使用Docker](#section_kig_gpy_uti)。
    -   制作镜像的示例操作，请参见[制作Docker镜像](#section_o3m_mmi_0bz)。
