...
2.  计算退款比例R
    ...
    R = \(0.7 USD/天 - 0.5 USD/天\)/1 USD/天= 1/5
...
节省计划支持三种付费方式：全预付、部分预付和0预付。不同的购买时长和付费方式对应的折扣力度不同，3年全预付的折扣最佳，然后依次为：3年部分预付，3年0预付，1年全预付，1年部分预付，1年0预付。更多说明请参见[节省计划](/intl.zh-CN/产品计费/计费方式/节省计划.md)。
...
更多信息，请参见[按量付费实例停机不收费](/intl.zh-CN/产品计费/计费方式/按量付费实例停机不收费.md)。
...
**说明：** 转成弹性公网IP后，ECS实例处于停机不收费状态时会收取弹性公网IP保有费。更多信息，请参见[弹性公网IP计费概述](/intl.zh-CN/产品计费/计费概述.md)。
...
带宽的计费说明请参见[公网带宽计费](/intl.zh-CN/产品计费/计费项/公网带宽计费.md)。
...
更多信息请参见[公网带宽计费](/intl.zh-CN/产品计费/计费项/公网带宽计费.md)。
...
您也可以通过续费降配转换带宽计费方式，新配置在下一个计费周期生效，具体操作请参见[续费降配](/intl.zh-CN/产品计费/续费实例/续费降配.md)。
