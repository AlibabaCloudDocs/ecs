...
SCU按照一定的折扣系数抵扣云盘的按量付费账单。更多详情，请参见[存储容量单位包抵扣规则](/intl.zh-CN/块存储/存储容量单位包/存储容量单位包抵扣规则.md)。
...
您可以通过FIO工具压测ESSD云盘性能，具体步骤请参见[压测ESSD云盘IOPS性能](/intl.zh-CN/块存储/性能/压测ESSD云盘IOPS性能.md)。
...
ESSD云盘支持挂载到25GE网络的实例规格族（g6、g6se、g5、g5se、ic5、c6、c5、r6、r5等）、裸金属服务器实例规格族（ebmhfg5、ebmc4、ebmg5、ebmgn6v、ebmgn6i、ebmc5s、ebmg5s、ebmr5s、sccgn6等）和企业级异构计算规格族（gn6i、gn6v、gn5、gn5i、gn4、f1、f3等）。更多详情，请参见[实例规格族](/intl.zh-CN/实例/实例规格族.md)。
...
1.  为当源数据盘创建快照。详情请参见[创建普通快照](/intl.zh-CN/快照/使用快照/创建普通快照.md)。
...
出于数据安全考虑，您需要提前创建快照备份云盘数据，发生操作失误时可以及时回滚云盘。详情请参见[创建快照](/intl.zh-CN/快照/使用快照/创建普通快照.md)和[使用快照回滚云盘](/intl.zh-CN/快照/使用快照/使用快照回滚云盘.md)。
