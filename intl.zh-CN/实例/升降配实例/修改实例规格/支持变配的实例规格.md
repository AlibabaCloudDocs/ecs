...
-   如需从g6、c6、r6升配至第六代增强型实例（g6e、c6e、r6e）和第7代实例（hfc7、hfg7、hfr7），请[提交工单](https://workorder-intl.console.aliyun.com/console.htm)。升配后，不支持降配。
-   第六代增强型实例（g6e、c6e、r6e）和第7代实例（hfc7、hfg7、hfr7）只支持ESSD云盘。如果实例挂载了其他类型的云盘，升配时会为您更换云盘并手动迁移数据，ESSD云盘的价格请参见[云产品定价页](https://www.alibabacloud.com/product/ecs)。 |
|g6se|-   g6se
-   g6e、c6e、r6e |
...
**说明：** 如需从g6e、c6e、r6e升配至第7代实例（hfc7、hfg7、hfr7），请[提交工单](https://workorder-intl.console.aliyun.com/console.htm)。升配后，不支持降配。 |
