...
以下表格中，可变配的目标规格族适用于包年包月实例和按量付费实例。变配方式请参见[升降配方式概述](/intl.zh-CN/实例/升降配实例/升降配方式概述.md)。
...
-   如需从g6、c6、r6升配至第六代增强型实例（g6e、c6e、r6e）和第7代实例（hfc7、hfg7、hfr7、g7、c7、r7），请[提交工单](https://workorder-intl.console.aliyun.com/console.htm)。升配后，不支持降配。
-   第六代增强型实例（g6e、c6e、r6e）和第7代实例（hfc7、hfg7、hfr7、g7、c7、r7）只支持ESSD云盘。如果实例挂载了其他类型的云盘，升配时会为您更换云盘并手动迁移数据，ESSD云盘的价格请参见[云产品定价页](https://www.alibabacloud.com/product/ecs)。 |
|g6se|g6se|
...
**说明：** 如需从g6e、c6e、r6e升配至第7代实例（hfc7、hfg7、hfr7、g7ne），请[提交工单](https://workorder-intl.console.aliyun.com/console.htm)。升配后，不支持降配。 |
...
-   普通第五代实例（g5、c5、r5、ic5）支持升配至第六代增强型实例（g6e、c6e、r6e），如需升配，请[提交工单](https://workorder-intl.console.aliyun.com/console.htm)。升配后，不支持降配。
-   第六代增强型实例（g6e、c6e、r6e）只支持ESSD云盘。如果实例挂载了其他类型的云盘，升配时会为您更换云盘并手动迁移数据，ESSD云盘的价格请参见[云产品定价页](https://www.alibabacloud.com/product/ecs)。 |
...
-   如需从hfc6、hfg6、hfr6升配至第7代实例（hfc7、hfg7、hfr7），请[提交工单](https://workorder-intl.console.aliyun.com/console.htm)。升配后，不支持降配。
-   第7代实例（hfc7、hfg7、hfr7）只支持ESSD云盘。如果实例挂载了其他类型的云盘，升配时会为您更换云盘并手动迁移数据，ESSD云盘的价格请参见[云产品定价页](https://www.alibabacloud.com/product/ecs)。 |
|hfc5、 hfg5|-   hfc5、 hfg5
